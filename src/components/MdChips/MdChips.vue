<template>
  <md-field class="md-chips" :class="[$mdActiveTheme, chipsClasses]">
    ...
    <md-chip
      ...
      <slot name="md-chip" :chip="chip" v-if="$slots['md-chip']">{{ chip }}</slot>
...
<script>
  ...
  import MdField from '../MdField/MdField'
  import MdInput from '../MdField/MdInput/MdInput'
  import MdUuid from '../core/utils/MdUuid'
  import MdPropValidator from '../core/utils/MdPropValidator'

  export default new MdComponent({
    name: 'MdChips',
		emits:['md-click','md-insert','md-delete','update:modelValue'],
    components: {
      MdField,
      MdInput
    },
